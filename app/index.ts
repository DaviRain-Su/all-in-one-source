...
async function addNotionPageToDatabase(databaseId: string, pageProperties: PageProperties) {
  ...
  console.log(newPage.public_url);
}
...
async function main() {
  ...
  for (let i = 0; i < files.length; i++) {
    ...
    total_msg += propertiesForNewPages.length;
  }

  console.log(`共 ${files.length} 个文件，${total_msg} 条消息。`);
  ...
  for (let i = 0; i < files.length; i++) {
    ...
    console.log("🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟");
    console.log("🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟");
    console.log("🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟load file: ", `./data/${files[i]}`);
    loaded_file.push(`./data/${files[i]}`);
    const propertiesForNewPagesModule = await import(`./data/${files[i]}`);
    const propertiesForNewPages = propertiesForNewPagesModule.propertiesForNewPages;
    ...
    console.log("🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟");
    console.log("🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟");
    console.log("🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟已经load了🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟🌟 ", loaded_file);
  }
